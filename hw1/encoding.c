...
unsigned int to_uni(int c, enum encoding type);
...
void to_utf(unsigned int sym, char* utf, int* len){
  if(sym <= 0x7F){
    ...
    *len = 4;
    ...
    utf[1] = (0x80 | ((sym >> 12) & 0x3F));
    utf[2] = (0x80 | ((sym >> 6) & 0x3F));
    utf[3] = (0x80 | (sym & 0x3F));
    return;
  } 
...
enum encoding enc_type(char* str){
  ...
  if ( ((str[0] == 'w') || (str[0] == 'W'))
      && ((str[1] == 'i') || (str[1] == 'I'))
      && ((str[2] == 'n') || (str[2] == 'N')) ) return WIN; 
  //iso
  if ( ((str[0] == 'i') || (str[0] == 'I'))
      && ((str[1] == 's') || (str[1] == 'S'))
      && ((str[2] == 'o') || (str[2] == 'O')) ) return ISO; 
  return ERR; 
}
